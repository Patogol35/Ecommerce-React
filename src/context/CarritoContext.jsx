...
export function CarritoProvider({ children }) {
  ...
  // ✅ Actualiza cantidad absoluta y sincronizada con backend
  ...
  // ✅ Corregido: ahora relanza error en caso de fallo
  const agregarAlCarrito = async (producto_id, cantidad = 1) => {
    ...
    try {
      ...
      console.error(e);
      throw new Error(e.message || "No se pudo agregar el producto"); // 👈 relanza
    }
  };
